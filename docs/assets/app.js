const Guide = (() => {
  ...
  function shell(active = "", base = "") {
    ...
    document.querySelector("#site-header").innerHTML = `<a class="skip-link" href="#main">Skip to content</a><header class="site-header"><div class="nav-wrap"><a class="brand" href="${base}index.html"><span class="brand-mark">cSVD</span><span class="brand-copy"><strong>Evidence Guide</strong><small>Learn · verify · investigate</small></span></a><button class="nav-toggle" type="button" aria-label="Open navigation">Menu</button><nav class="site-nav" aria-label="Primary">${nav.map(([href,label,key])=>`<a href="${base}${href}" ${key===active?'aria-current="page"':''}>${label}</a>`).join("")}</nav></div></header>`;
    document.querySelector(".nav-toggle")?.addEventListener("click",()=>document.querySelector(".site-nav").classList.toggle("open"));
    document.querySelector("#site-footer").innerHTML = `<footer class="site-footer"><div class="container footer-grid"><div><strong>cSVD Evidence Guide <span class="version">v0.6</span></strong><p class="fine">A web-native field guide and evidence workspace for CAA, brain arteriolosclerosis, and the wider small-vessel disease spectrum.</p></div><div><strong>Use responsibly</strong><p class="fine">Research and education only. No patient data. Findings are not diagnoses or treatment recommendations.</p></div><div><strong>Project</strong><p class="fine"><a href="https://github.com/kingkhalid310/cerebral-small-vessel-disease-evidence-guide">GitHub repository</a><br><a href="${base}about.html#citation">Citation and methods</a></p></div></div></footer>`;
  }

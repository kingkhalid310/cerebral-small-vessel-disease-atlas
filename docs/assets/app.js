const Atlas = (() => {
  ...
  function shell(active = "", base = "") {
    ...
    document.querySelector("#site-footer").innerHTML = `<footer class="site-footer"><div class="container footer-grid"><div><strong>cSVD Evidence Atlas <span class="version">v0.5</span></strong><p class="fine">A web-native field guide and evidence workspace for CAA, brain arteriolosclerosis, and mixed small-vessel disease.</p></div><div><strong>Use responsibly</strong><p class="fine">Research and education only. No patient data. Findings are not diagnoses.</p></div><div><strong>Project</strong><p class="fine"><a href="https://github.com/kingkhalid310/cerebral-small-vessel-disease-atlas">GitHub repository</a><br><a href="${base}about.html#citation">Citation and methods</a></p></div></div></footer>`;
  }

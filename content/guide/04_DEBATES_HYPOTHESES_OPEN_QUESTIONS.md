...
| Claim | Current confidence | Strongest support | Strongest limitation | Priority next step |
|---|---|---|---|---|
...
| Mixed pathology explains much late-life cognitive variance | High | Repeated autopsy cohorts | Attribution and interaction models remain difficult | Longitudinal multimodal-pathology cohorts |
